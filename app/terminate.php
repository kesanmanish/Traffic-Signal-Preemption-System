...
$query2 = " DELETE FROM emergency WHERE amb_id= '$ambid' ";
$res1= mysql_query($query2) or die("Unable to delete the data because : " . mysql_error());
echo $res1;


$query3 = " INSERT INTO log (amb_id ,t_sigid,l_event) VALUES ($ambid,2,'EMERGENCY_END')";
$res1= mysql_query($query3) or die("Unable to Insert the data because : " . mysql_error());
